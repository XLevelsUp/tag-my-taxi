    ...
    <div className="flex flex-col min-h-screen bg-white font-sans text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <Link href="/contact">
                <button className="mt-2 bg-[#E31E24] hover:bg-red-700 text-white font-bold text-sm px-8 py-3 rounded transition-colors">
                  Get Started
                </button>
              </Link>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <Link href="/contact">
            <button className="bg-[#E31E24] hover:bg-red-700 text-white font-bold text-sm px-10 py-3 rounded transition-colors">
...
function CheckItem({ text }: { text: string }) {
  return (
    <li className="flex items-start gap-3">
      <Check className="text-[#E31E24] w-5 h-5 mt-0.5 shrink-0" />
